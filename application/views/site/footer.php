<div class="row" >
		...
		<div class="row" id="footer" style="background-color: yellow; ">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
					<address>
					  <strong>   HTHT SHOP </strong><br>
					  <span class="glyphicon glyphicon-home" aria-hidden="true"></span> Địa chỉ: 99 Tô Hiến Thành<br>
					  <span class="glyphicon glyphicon-phone" aria-hidden="true"></span> Điện thoại: 0352998934<br>
					  Copyright ©2021
					</address>
				</div>
				<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 text-right">
					<a href="https://www.facebook.com/minh.quyn.99/"><img src="<?php echo base_url(); ?>upload/icon/facebook.png" alt=""></a>
					<a href="https://www.facebook.com/minh.quyn.99/"><img src="<?php echo base_url(); ?>upload/icon/twitter.png" alt=""></a>
					<a href="https://www.facebook.com/minh.quyn.99/"><img src="<?php echo base_url(); ?>upload/icon/google.png" alt=""></a>
				</div>
